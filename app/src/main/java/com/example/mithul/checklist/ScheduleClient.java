...
public class ScheduleClient {
     ...
     */
    public void setAlarmForNotification(Calendar c, String message, CharSequence title, String mode) {
        mBoundService.setAlarm(c, message, title, mode);
        Log.w("Client", message + title + mode);
    }
